...
export default function GroupPage({ user }) {
  ...
  const places = schedule?.available ? (schedule.places || []) : []
    ...
    <div className="min-h-screen bg-light">
      ...
      <div className="bg-hero px-6 py-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
            <div>
              <h1 className="text-3xl font-extrabold text-dark">{group.group_name || group.name}</h1>
      ...
      >
        <div className="flex flex-col gap-8">
          <div className="card card-elevated">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-5">
              <div>
                <h2 className="font-bold text-dark text-lg">Members</h2>
          ...
          <div className="card card-elevated">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-5">
              <div>
                <h2 className="font-bold text-dark text-lg">Shared Availability Board</h2>
          ...
          <div className="card card-elevated">
            <div className="flex items-start justify-between gap-4 mb-5">
              <div>
                <h2 className="font-bold text-dark text-lg">Add Your Availability</h2>
          ...
          <div className="card border-2 border-dashed border-[#b5e8c8] bg-[#f0fdf4] card-elevated">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex-1">
                <h2 className="font-bold text-dark text-lg">Find Common Time</h2>
        ...
        <div className="flex flex-col gap-6 xl:sticky xl:top-6">
          ...
          {schedule?.available && places.length > 0 ? (
            <div>
              <div className="mb-4">
                <span className="section-badge bg-white">Recommended Places</span>
                <p className="text-dark/60 text-sm mt-2">
                  Seasonal suggestions for {formatDisplayDate(schedule.date)}. Click any card to open Google Maps results.
                </p>
              </div>
              <div className="flex flex-col gap-4">
                {places.map((place) => {
                  const mapsUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${place.name} ${mapsSearchTerms}`)}`
                  ...
                  return (
                    ...
                    >
                      <div>
                        ...
                        <p className="text-dark/60 text-sm leading-relaxed mt-1">{place.description}</p>
                      </div>
                      <span className="text-xs font-semibold text-muted mt-3">Open in Google Maps</span>
                    </a>
                  )
                })}
              </div>
            ...
            <div className="card text-center py-10">
              <div className="w-14 h-14 bg-card rounded-full flex items-center justify-center mx-auto mb-3 text-xl">
                Map
              </div>
              <h3 className="font-bold text-dark mb-1">Place Recommendations</h3>
              <p className="text-dark/50 text-sm leading-relaxed">
                Once a common time appears, SyncUp will surface season-aware places you can open directly in Google Maps.
              </p>
            </div>
          )}
